...
#define AES_CTR_TESTS_BYTES 64
    ...
    aesm_ctr_encrypt(output,pt_vector, m_vector, AES_CTR_TESTS_BYTES,key_vector, iv_vector);

    printf("cipher text: \n");
    dump_hex(output,AES_CTR_TESTS_BYTES);
    
    aes_ctr_decrypt(input,output,m_vector,AES_CTR_TESTS_BYTES,key_vector, iv_vector);
